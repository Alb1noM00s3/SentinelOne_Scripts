...
Read-Host -Prompt "Hello...Press Enter to Begin Data Collection"
...
Write-Host "Unresolved Threats Collected, Beginning VirusTotal Check"
...
Read-Host -Prompt "Hash Report for Unresolved Threats Fetched. Press Enter to Exit"
